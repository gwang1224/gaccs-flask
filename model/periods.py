...
def initPeriods():
    with app.app_context():
        ...
        u3 = Period(periodlength='7', cyclelength='40', nextperiod='2/21/23', nextovulation='February 9')
        u4 = Period(periodlength='4', cyclelength='21', nextperiod='2/19/23', nextovulation='February 6')
