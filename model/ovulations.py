...
def initOvulations():
    with app.app_context():
        ...
        u1 = Ovulation(perioddate='January 25', periodcycle='5', menscycle='28')
        u2 = Ovulation(perioddate='March 1', periodcycle='7', menscycle='30')
        u3 = Ovulation(perioddate='August 13', periodcycle='4', menscycle='29')
        ...
        for user in users:
            try:
                ...
                for num in range(randrange(1, 4)):
                    note = "#### " + user.menscycle + " note " + str(num) + ". \n Generated by test data."
